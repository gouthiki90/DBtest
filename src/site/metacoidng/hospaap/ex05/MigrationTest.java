...
public class MigrationTest {
    ...
    public static ResponseDto download() {
        ...
        try {
            ...
            sb.append("1");
            sb.append("&numOfRows=");
            sb.append(getTotalCount()); // totalCount 체크만 할 것이기 때문에 2개만 받아도 된다. (왜 2개냐면 1개만 받으면 List가 아니라 Object로 받더라)
            sb.append("&_type=");
            sb.append("json"); // 데이터 포맷은 JSON
            ...
            if (responseDto.getResponse().getBody().getItems().getItem().size() == getTotalCount()) {
